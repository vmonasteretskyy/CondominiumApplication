			...
			<div class="pg-elem">
				<div class="wrap">
					...
					<div class="input-top h3">
						...
						<p><span id="vote-current">0</span><span id="vote-limit">2</span> votes remaining</p>
					</div>
					<div class="vote-variants">
						<div class="vote-cands" data-vote-limit="2">
							...
							<div class="vote-variant vote-cand">
								<span class="h2 vote-name">Anthony Ing</span>
							...
							<!-- begin cand example -->
							<div class="vote-variant vote-cand">
								<span class="h2 vote-name">Shirley Wang</span>
								<div class="vote-num"></div>
								<button type="button" class="icon-cross close-cand"></button>
							</div>
							<!-- end cand example -->
							<!-- begin cand example -->
							<div class="vote-variant vote-cand">
								<span class="h2 vote-name">Sutha Somasundaram</span>
								<div class="vote-num"></div>
								<button type="button" class="icon-cross close-cand"></button>
							</div>
							<!-- end cand example -->
