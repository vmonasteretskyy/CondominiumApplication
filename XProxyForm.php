		...
		<div id="pg-slider">
			...
			<div class="pg-elem">
				<div class="wrap">
					...
					<p>Which cand(s) do you vote to elect for the <a class="slink" onclick="openHPopup('right-ha-non-leased', 'non-leased-popup')"><span class="bef"><</span><span class="sunderline">non-leased voting unit director position</span><span class="aft">></span> <i class="icon-info-hovering"></i></a> on the board</p>
